...
SOAP_SOURCE_STAMP("@(#) soapC.c ver 2.8.14 2016-06-23 06:05:19 GMT")
...
{	(void)tag;
	...
	case SOAP_TYPE__int:
		return soap_out__int(soap, "int", id, (const int *)ptr, NULL);
	case SOAP_TYPE__i4:
...
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_value(struct soap *soap, const struct value *a)
{
	...
	/* transient value skipped */
	/* transient value skipped */
	/* transient operator struct _array & skipped */
	/* transient operator const struct _array & skipped */
	/* transient operator struct _base64 & skipped */
	/* transient operator const struct _base64 & skipped */
	/* transient operator char * skipped */
	/* transient operator std::string skipped */
	/* transient operator wchar_t * skipped */
	/* transient operator std::wstring skipped */
	/* transient operator double skipped */
	/* transient operator int skipped */
	/* transient operator time_t skipped */
	/* transient operator struct _struct & skipped */
	/* transient operator const struct _struct & skipped */
	/* transient operator[] skipped */
	/* transient operator[] skipped */
	/* transient operator= skipped */
	/* transient operator= skipped */
	...
	/* transient size skipped */
	/* transient empty skipped */
	/* transient is_array skipped */
	/* transient is_base64 skipped */
	/* transient is_bool skipped */
	/* transient is_double skipped */
	/* transient is_false skipped */
	/* transient is_int skipped */
	/* transient is_string skipped */
	/* transient is_struct skipped */
	/* transient is_true skipped */
	/* transient is_dateTime skipped */
	soap_markelement(soap, a->ref, a->__type);
	soap_serialize__string(soap, &a->__any);
	/* transient soap skipped */
#endif
}
...
SOAP_FMAC3 int SOAP_FMAC4 soap_out_value(struct soap *soap, const char *tag, int id, const struct value *a, const char *type)
{
	...
	if (soap_putelement(soap, a->ref, "ref", -1, a->__type))
		return soap->error;
	if (soap_out__string(soap, "-any", -1, &a->__any, ""))
		return soap->error;
	/* transient soap skipped */
	return soap_element_end_out(soap, tag);
}
...
SOAP_FMAC3 struct value * SOAP_FMAC4 soap_in_value(struct soap *soap, const char *tag, struct value *a, const char *type)
{
	...
	if (soap_element_begin_in(soap, tag, 0, type))
		return NULL;
	a = (struct value *)soap_id_enter(soap, soap->id, a, SOAP_TYPE_value, sizeof(struct value), 0, NULL, NULL, NULL);
	if (!a)
		return NULL;
	...
	if (soap->body && !*soap->href)
	{
		...
		/* transient soap skipped */
			if (soap_flag___any && (soap->error == SOAP_TAG_MISMATCH || soap->error == SOAP_NO_TAG))
				if (soap_in__string(soap, "-any", &a->__any, ""))
				{	soap_flag___any--;
					continue;
				}
			if (soap->error == SOAP_TAG_MISMATCH)
	...
	{	a = (struct value *)soap_id_forward(soap, soap->href, (void*)a, 0, SOAP_TYPE_value, 0, sizeof(struct value), 0, NULL);
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
	return a;
...
{
	register int id = soap_embed(soap, (void*)a, NULL, 0, tag, SOAP_TYPE_value);
	if (soap_out_value(soap, tag?tag:"value", id, a, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
{
	id = soap_element_id(soap, tag, id, *a, NULL, 0, type, SOAP_TYPE_value);
	if (id < 0)
		return soap->error;
...
SOAP_FMAC3 struct value ** SOAP_FMAC4 soap_in_PointerTovalue(struct soap *soap, const char *tag, struct value **a, const char *type)
{
	...
	*a = NULL;
	...
	{	a = (struct value **)soap_id_lookup(soap, soap->href, (void**)a, SOAP_TYPE_value, sizeof(struct value), 0);
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
	return a;
...
{
	register int id = soap_embed(soap, (void*)a, NULL, 0, tag, SOAP_TYPE_PointerTovalue);
	if (soap_out_PointerTovalue(soap, tag?tag:"value", id, a, type))
		return soap->error;
	return soap_putindependent(soap);
}
